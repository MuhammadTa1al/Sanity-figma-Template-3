      ...
      <div className="flex flex-col h-screen bg-gray-100">
        ...
        <nav className="bg-black text-white p-4 shadow-lg flex justify-between">
          ...
          <div className="flex space-x-4">
            ...
            <button
              className="mt-6 px-6 py-3 bg-black text-[#FFFFFF] font-medium rounded-full hover:bg-gray-800 transition"
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <button
                          ...
                          className="bg-black text-white px-3 py-1 rounded hover:bg-gray-500 transition"
                        >
                          Delete
                        </button>
                      </td>
